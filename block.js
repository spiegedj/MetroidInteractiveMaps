...
var DoorType;
(function (DoorType) {
    DoorType["Normal"] = "Normal";
    DoorType["Missile"] = "Missile";
    DoorType["SuperMissile"] = "SuperMissile";
    DoorType["PowerBomb"] = "PowerBomb";
    DoorType["Hidden"] = "Hidden";
    DoorType["Blue"] = "Blue";
    DoorType["Yellow"] = "Yellow";
})(DoorType || (DoorType = {}));
class Block {
    constructor(canvas, context, room, x, y, blockType, doors) {
        this.__canvas = canvas;
        this.__ctx = context;
        this.__room = room;
        this.x = Number(x);
        this.y = Number(y);
        this.doors = doors || new Map();
    ...
    draw(size) {
        ...
        this.__timeoutHandle = setTimeout(function () {
            var areaImage = Areas[this.__room.map.game][this.getArea()];
            if (areaImage) {
    ...
    __normalDoor(size, direction, doorColor) {
        var ctx = this.__ctx;
        var x = this.x;
        var y = this.y;
        var dW = size / 5;
